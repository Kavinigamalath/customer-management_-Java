...
<head>
    ...
    <title>Update Profile | Customer Management</title>
...
<header class="main-header">
    <div class="header-content">
        ...
        <nav class="nav-links">
            ...
            <a href="new"><i class="fas fa-users"></i> Customers</a>
        ...
        <div class="form-container">
            <form action="update" method="get" onsubmit="return validateForm()">
                ...
                <div class="form-group">
                    ...
                    <input type="text" id="uname" name="uname" class="form-control" value="${service.uname}" required placeholder="Enter username">
                </div>
